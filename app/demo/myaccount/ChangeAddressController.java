...
public class ChangeAddressController extends SunriseChangeAddressController<DefaultAddressBookAddressFormData> {
    ...
    @Override
    public CompletionStage<Result> handleSuccessfulAction(final DefaultAddressBookAddressFormData formData, final AddressBookActionData context, final Customer updatedCustomer) {
        return redirectTo(addressBookReverseRouter.addressBookCall());
    }
}
