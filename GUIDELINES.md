General guidelines about how to successfully develop an application based on [commercetools JVM SDK](https://github.com/commercetools/sphere-jvm-sdk) with [Play Framework](https://www.playframework.com/).
