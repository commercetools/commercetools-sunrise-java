...
final class DefaultAddToCartFormAction implements AddToCartFormAction {
    ...
    @Inject
    DefaultAddToCartFormAction(final MyCartUpdater myCartUpdater, final CartCreator cartCreator, final CurrencyUnit currency) {
