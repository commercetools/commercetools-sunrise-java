...
final class DefaultRemoveDiscountCodeFormAction implements RemoveDiscountCodeFormAction {

    private final MyCartUpdater myCartUpdater;

    @Inject
    DefaultRemoveDiscountCodeFormAction(final MyCartUpdater myCartUpdater) {
