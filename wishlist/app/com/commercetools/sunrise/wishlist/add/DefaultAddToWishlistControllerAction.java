...
final class DefaultAddToWishlistControllerAction implements AddToWishlistControllerAction {

    private final MyWishlistUpdater myWishlistUpdater;
    private final MyWishlistCreator myWishlistCreator;

    @Inject
    DefaultAddToWishlistControllerAction(final MyWishlistUpdater myWishlistUpdater, final MyWishlistCreator myWishlistCreator) {
