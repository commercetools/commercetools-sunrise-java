...
public class DefaultClearWishlistFormAction implements ClearWishlistFormAction {

    private final MyWishlistUpdater myWishlistUpdater;
    private final MyWishlistInCache myWishlistInCache;

    @Inject
    protected DefaultClearWishlistFormAction(final MyWishlistUpdater myWishlistUpdater, final MyWishlistInCache myWishlistInCache) {
