...
public abstract class SunriseResetPasswordController extends SunriseController {
    ...
    public CompletionStage<Result> showResetPasswordRequest() {
    ...
    public CompletionStage<Result> showResetPassword(final String passwordToken) {
    ...
    public CompletionStage<Result> processResetPasswordRequest() {
    ...
    public CompletionStage<Result> processResetPassword() {
