...
@ImplementedBy(DefaultChangeAddressFunction.class)
@FunctionalInterface
public interface ChangeAddressFunction extends BiFunction<AddressWithCustomer, AddressBookAddressFormData, CompletionStage<Customer>> {
