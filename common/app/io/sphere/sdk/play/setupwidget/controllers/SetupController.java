...
import io.sphere.sdk.play.setupwidget.models.SphereCredentials;
...
public class SetupController extends Controller {
    ...
    private static Result renderFormImpl() {
        return ok(io.sphere.sdk.play.setupwidget.views.html.setup.render(sphereCredentialsForm));
    }
    ...
    private static Result processFormImpl() {
        ...
        if (filledForm.hasErrors()) {
            result = badRequest(io.sphere.sdk.play.setupwidget.views.html.setup.render(filledForm));
        } else {
            ...
            result = ok(io.sphere.sdk.play.setupwidget.views.html.success.render());
        }
        return result;
    }
