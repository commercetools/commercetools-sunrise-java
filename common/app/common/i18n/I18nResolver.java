...
public interface I18nResolver {
     ...
     */
    Optional<String> get(final Locale locale, final String bundle, final String key, final Object... args);
     ...
     */
    default Optional<String> get(final List<Locale> locales, final String bundle, final String key, final Object... args) {
        for (final Locale locale : locales) {
            final Optional<String> message = get(locale, bundle, key, args);
