package com.commercetools.sunrise.core.injection;
    ...
    private static class HttpContextScopeProvider<T> implements Provider<T> {
        ...
        public T get() {
            ...
            if (currentContext != null) {
                return provideFromContext(currentContext);
            } else {
        ...
        private T provideFromCache(final Cache cache) {
