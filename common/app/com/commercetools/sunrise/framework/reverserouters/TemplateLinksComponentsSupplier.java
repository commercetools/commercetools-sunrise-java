...
public class TemplateLinksComponentsSupplier implements ControllerComponentsSupplier {

    private final List<ControllerComponent> controllerComponents = new ArrayList<>();

    @Inject
    public TemplateLinksComponentsSupplier(final LocalizationLinksControllerComponent localizationLinksControllerComponent,
