...
public final class DefaultChangeLanguageFormAction implements ChangeLanguageFormAction {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeLanguageFormAction.class);
