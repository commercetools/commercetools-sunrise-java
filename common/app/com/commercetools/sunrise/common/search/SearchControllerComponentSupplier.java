...
public class SearchControllerComponentSupplier implements ControllerComponentSupplier {

    private final List<ControllerComponent> components = new ArrayList<>();

    @Inject
    public SearchControllerComponentSupplier(final SortSelectorControllerComponent sortSelectorControllerComponent,
