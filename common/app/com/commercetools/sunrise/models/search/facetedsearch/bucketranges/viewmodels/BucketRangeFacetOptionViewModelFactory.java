...
public class BucketRangeFacetOptionViewModelFactory extends AbstractFacetOptionViewModelFactory<RangeStats, BucketRangeFacetedSearchFormOption, List<String>> {
    ...
    @Override
    public final FacetOption create(final RangeStats stats, final BucketRangeFacetedSearchFormOption value, @Nullable final List<String> selectedValue) {
        return super.create(stats, value, selectedValue);
    }

    @Override
    protected final void initialize(final FacetOption viewModel, final RangeStats stats, final BucketRangeFacetedSearchFormOption value, @Nullable final List<String> selectedValue) {
        super.initialize(viewModel, stats, value, selectedValue);
    }

    @Override
    protected void fillLabel(final FacetOption viewModel, final RangeStats stats, final BucketRangeFacetedSearchFormOption option, @Nullable final List<String> selectedValues) {
        viewModel.setLabel(i18nResolver.getOrKey(option.getFieldLabel()));
    }

    @Override
    protected void fillValue(final FacetOption viewModel, final RangeStats stats, final BucketRangeFacetedSearchFormOption option, @Nullable final List<String> selectedValues) {
        viewModel.setValue(option.getFieldValue());
    }

    @Override
    protected void fillSelected(final FacetOption viewModel, final RangeStats stats, final BucketRangeFacetedSearchFormOption option, @Nullable final List<String> selectedValues) {
    ...
    @Override
    protected void fillCount(final FacetOption viewModel, final RangeStats stats, final BucketRangeFacetedSearchFormOption option, @Nullable final List<String> selectedValue) {
