...
public final class CustomerDisplayingComponent implements ControllerComponent, PageDataHook {

    private final MyCustomerInCache myCustomerInCache;

    @Inject
    CustomerDisplayingComponent(final MyCustomerInCache myCustomerInCache) {
