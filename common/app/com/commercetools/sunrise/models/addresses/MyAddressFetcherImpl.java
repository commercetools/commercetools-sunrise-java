...
final class MyAddressFetcherImpl implements MyAddressFetcher {

    private final MyCustomerFetcher myCustomerFetcher;
    private final HookRunner hookRunner;

    @Inject
    MyAddressFetcherImpl(final MyCustomerFetcher myCustomerFetcher, final HookRunner hookRunner) {
