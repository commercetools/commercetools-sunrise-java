...
public class CheckoutShippingContent extends PageContent {
    ...
    public CheckoutShippingContent(final Form<CheckoutShippingFormData> filledForm, final Cart cart, final Messages messages, final Configuration configuration, final ReverseRouter reverseRouter, final UserContext userContext, final Http.Flash flash, final String csrfToken, final ShippingMethods shippingMethods, final ProductDataConfig productDataConfig) {
        fillDefaults(cart, userContext, productDataConfig);
