...
public class CheckoutShippingController extends CartController {
    ...
    @Inject
    public CheckoutShippingController(final ControllerDependency controllerDependency, final ShippingMethods shippingMethods, final CSRF.TokenProvider csrfTokenProvider) {
    ...
    public F.Promise<Result> show(final String languageTag) {
        ...
        return cartPromise.map(cart -> {
            ...
            final CheckoutShippingContent content = new CheckoutShippingContent(cart, messages, configuration(), reverseRouter(), userContext, flash(), csrfTokenProvider.generateToken(), shippingMethods);
